    ...
    <section class="panel">
        ...
        <div class="panel-body">
            ...
            <div class="position-center">
                ...
                <form role="form" action="{{URL::to('/update-products/'.$pro->product_id)}}" method="post" enctype="multipart/form-data">
                    {{csrf_field()}}
                    ...
                    <div class="form-group">
                        ...
                        <img src="{{URL::to('public/uploads/products/'.$pro->product_image)}}" width="100" height="100">
                    </div>
